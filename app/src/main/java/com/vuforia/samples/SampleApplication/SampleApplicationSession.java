...
{
    private String licenseKey = "";
    
    private static final String LOGTAG = "SampleAppSession";
    
    // Reference to the current activity
    private Activity mActivity;
    private com.vuforia.samples.SampleApplication.SampleApplicationControl mSessionControl;
    ...
    public SampleApplicationSession(com.vuforia.samples.SampleApplication.SampleApplicationControl sessionControl)
    {
    ...
    {
        com.vuforia.samples.SampleApplication.SampleApplicationException vuforiaException = null;
        mActivity = activity;
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new com.vuforia.samples.SampleApplication.SampleApplicationException(
                com.vuforia.samples.SampleApplication.SampleApplicationException.VUFORIA_ALREADY_INITIALIZATED,
                logMessage);
        ...
        if (vuforiaException == null)
        {
            ...
            catch (Exception e)
            {
                ...
                vuforiaException = new com.vuforia.samples.SampleApplication.SampleApplicationException(
                    com.vuforia.samples.SampleApplication.SampleApplicationException.INITIALIZATION_FAILURE,
                    logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }
    ...
    private void startCameraAndTrackers(int camera) throws com.vuforia.samples.SampleApplication.SampleApplicationException
    {
        String error;
        if(mCameraRunning)
        {
        	...
        	Log.e(LOGTAG, error);
            throw new com.vuforia.samples.SampleApplication.SampleApplicationException(
                com.vuforia.samples.SampleApplication.SampleApplicationException.CAMERA_INITIALIZATION_FAILURE, error);
        }
    ...
    public void startAR(int camera)
    {
        ...
        catch (Exception e)
        {
            ...
            vuforiaException = new com.vuforia.samples.SampleApplication.SampleApplicationException(
                    com.vuforia.samples.SampleApplication.SampleApplicationException.CAMERA_INITIALIZATION_FAILURE,
                    logMessage);
            Log.e(LOGTAG, logMessage);
        }
    ...
    public void stopAR() throws com.vuforia.samples.SampleApplication.SampleApplicationException
    {
        ...
        synchronized (mLifecycleLock)
        {
            ...
            if (!unloadTrackersResult)
                throw new com.vuforia.samples.SampleApplication.SampleApplicationException(
                    com.vuforia.samples.SampleApplication.SampleApplicationException.UNLOADING_TRACKERS_FAILURE,
                    "Failed to unload trackers\' data");
            
            if (!deinitTrackersResult)
                throw new com.vuforia.samples.SampleApplication.SampleApplicationException(
                    com.vuforia.samples.SampleApplication.SampleApplicationException.TRACKERS_DEINITIALIZATION_FAILURE,
    ...
    public void pauseAR() throws com.vuforia.samples.SampleApplication.SampleApplicationException
    {
        if (mStarted)
        {
            stopCamera();
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                ...
                catch (Exception e)
                {
                    ...
                    vuforiaException = new com.vuforia.samples.SampleApplication.SampleApplicationException(
                            com.vuforia.samples.SampleApplication.SampleApplicationException.TRACKERS_INITIALIZATION_FAILURE,
                            logMessage);
                    Log.e(LOGTAG, logMessage);
                }
            } else
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                ...
                catch (Exception e)
                {
                    ...
                    vuforiaException = new com.vuforia.samples.SampleApplication.SampleApplicationException(
                            com.vuforia.samples.SampleApplication.SampleApplicationException.LOADING_TRACKERS_FAILURE,
                            logMessage);
                }
            }
            else
    ...
    private class StartVuforiaTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mLifecycleLock)
            {
                ...
                catch (com.vuforia.samples.SampleApplication.SampleApplicationException e)
                {
